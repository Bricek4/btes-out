...
<template>
  <div class="app-root">
    <SidebarNav :active="activeSection" :collapsed="sidebarCollapsed" :inert="showLogin || undefined" :aria-hidden="showLogin || undefined" @select="selectSection" @toggle="sidebarCollapsed = !sidebarCollapsed" />

    <main class="app-main" :inert="showLogin || undefined" :aria-hidden="showLogin || undefined">
      <header class="topbar">
