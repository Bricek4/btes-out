...
/** Templates carry declarative content only; custom JavaScript is explicitly rejected. */
@RestController
...
public class TemplateController {
  ...
  private static String required(String v,String name){if(v==null||v.isBlank())throw new IllegalArgumentException(name+" is required");return v;}
  ...
  private static Object parseJson(String value){try{return new tools.jackson.databind.ObjectMapper().readValue(value,Object.class);}catch(tools.jackson.core.JacksonException e){throw new IllegalStateException("stored template JSON is invalid",e);}}
}
